...
class TestGameGameIdActionPostRequest(unittest.TestCase):
    """GameGameIdActionPostRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GameGameIdActionPostRequest:
        """Test GameGameIdActionPostRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GameGameIdActionPostRequest`
        """
        model = GameGameIdActionPostRequest()
        if include_optional:
            return GameGameIdActionPostRequest(
                accepted_at = '',
                chips = {
                    'key' : 56
                    },
    ...
    def testGameGameIdActionPostRequest(self):
        """Test GameGameIdActionPostRequest"""
