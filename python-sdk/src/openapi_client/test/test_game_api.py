...
class TestGameApi(unittest.IsolatedAsyncioTestCase):
    ...
    async def test_game_game_id_listener_listener_id_get(self) -> None:
        """Test case for game_game_id_listener_listener_id_get

        Get Next Event
        """
        pass

    async def test_game_game_id_listener_post(self) -> None:
        """Test case for game_game_id_listener_post
