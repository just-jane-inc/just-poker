...
class TestGameApi(unittest.IsolatedAsyncioTestCase):
    ...
    async def test_game_game_id_delete(self) -> None:
        """Test case for game_game_id_delete
    ...
    async def test_game_game_id_state_post(self) -> None:
        """Test case for game_game_id_state_post
