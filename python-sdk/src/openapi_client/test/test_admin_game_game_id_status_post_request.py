...
class TestAdminGameGameIdStatusPostRequest(unittest.TestCase):
    """AdminGameGameIdStatusPostRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AdminGameGameIdStatusPostRequest:
        """Test AdminGameGameIdStatusPostRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AdminGameGameIdStatusPostRequest`
        """
        model = AdminGameGameIdStatusPostRequest()
        if include_optional:
            return AdminGameGameIdStatusPostRequest(
                status = 'paused'
            )
        else:
            return AdminGameGameIdStatusPostRequest(
    ...
    def testAdminGameGameIdStatusPostRequest(self):
        """Test AdminGameGameIdStatusPostRequest"""
