...
class TestAdminGameGameIdTablePostRequest(unittest.TestCase):
    """AdminGameGameIdTablePostRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AdminGameGameIdTablePostRequest:
        """Test AdminGameGameIdTablePostRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AdminGameGameIdTablePostRequest`
        """
        model = AdminGameGameIdTablePostRequest()
        if include_optional:
            return AdminGameGameIdTablePostRequest(
    ...
    def testAdminGameGameIdTablePostRequest(self):
        """Test AdminGameGameIdTablePostRequest"""
