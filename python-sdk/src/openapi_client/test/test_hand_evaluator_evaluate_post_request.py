...
class TestHandEvaluatorEvaluatePostRequest(unittest.TestCase):
    """HandEvaluatorEvaluatePostRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> HandEvaluatorEvaluatePostRequest:
        """Test HandEvaluatorEvaluatePostRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `HandEvaluatorEvaluatePostRequest`
        """
        model = HandEvaluatorEvaluatePostRequest()
        if include_optional:
            return HandEvaluatorEvaluatePostRequest(
            )
        else:
            return HandEvaluatorEvaluatePostRequest(
        )
    ...
    def testHandEvaluatorEvaluatePostRequest(self):
        """Test HandEvaluatorEvaluatePostRequest"""
