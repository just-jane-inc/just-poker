...
class TestGameGameIdChipExchangePostRequest(unittest.TestCase):
    """GameGameIdChipExchangePostRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GameGameIdChipExchangePostRequest:
        """Test GameGameIdChipExchangePostRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GameGameIdChipExchangePostRequest`
        """
        model = GameGameIdChipExchangePostRequest()
        if include_optional:
            return GameGameIdChipExchangePostRequest(
                give = {
                    'key' : 56
                    },
                receive = {
    ...
    def testGameGameIdChipExchangePostRequest(self):
        """Test GameGameIdChipExchangePostRequest"""
