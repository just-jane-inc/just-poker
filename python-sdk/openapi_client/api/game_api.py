...
class GameApi:
    ...
    def game_game_id_action_post(
        ...
        game_game_id_action_post_request: Annotated[
            GameGameIdActionPostRequest,
            Field(description="the action the player is preforming"),
        ],
    ...
    def game_game_id_chip_exchange_post(
        self,
        game_id: Annotated[
            StrictInt, Field(description="ID of the Game exchange chips in")
        ],
        game_game_id_chip_exchange_post_request: Annotated[
            GameGameIdChipExchangePostRequest,
            Field(description="a specification for the chips to exchange"),
        ],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def game_game_id_player_post(
        self,
        game_id: Annotated[StrictInt, Field(description="ID of the Game to join")],
    ...
    def game_game_id_state_get(
        self,
        game_id: Annotated[
            StrictInt, Field(description="ID of the Game to get the state of")
        ],
        body: Optional[Dict[str, Any]] = None,
        _request_timeout: Union[
            None,
    ...
    def hand_evaluator_evaluate_post(
        self,
        hand_evaluator_evaluate_post_request: Annotated[
            Optional[HandEvaluatorEvaluatePostRequest],
            Field(description="hand to evaluate, either 5 or 7 cards"),
        ],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
