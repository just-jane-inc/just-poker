...
class GameHandDTO(BaseModel):
    ...
    big_blind: Optional[StrictInt] = Field(
        default=None, description="the amount of chips for the big blind in this hand"
    )
    button: Optional[StrictInt] = Field(
        default=None,
        description="the index of the position of the player who has the button",
    )
    count: Optional[StrictInt] = Field(
        default=None, description="the (non decreasing) hand counter"
    )
    id: Optional[StrictStr] = Field(default=None, description="the id of a hand")
    small_blind: Optional[StrictInt] = Field(
        default=None, description="the amount of chips for the small blind in this hand"
    )
    started_at: Optional[StrictStr] = Field(
        default=None, description="the time that this hand started"
    )
