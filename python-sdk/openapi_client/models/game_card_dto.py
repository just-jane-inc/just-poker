...
class GameCardDTO(BaseModel):
    ...
    rank: Optional[StrictInt] = Field(
        default=None, description="the rank of a card as a rune - int32 ASCII encoding"
    )
    suit: Optional[StrictInt] = Field(
        default=None, description="the suit of a card as a rune - int32 ASCII encoding"
    )
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({"rank": obj.get("rank"), "suit": obj.get("suit")})
        return _obj
