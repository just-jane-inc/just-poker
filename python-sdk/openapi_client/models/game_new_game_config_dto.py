...
class GameNewGameConfigDTO(BaseModel):
    ...
    player_count: Optional[StrictInt] = Field(
        default=None, description="the number of players (max) the game supports"
    )
    small_blind: Optional[StrictInt] = Field(
        default=None, description="the small blind"
    )
    starting_chips: Optional[Dict[str, StrictInt]] = Field(
        default=None,
