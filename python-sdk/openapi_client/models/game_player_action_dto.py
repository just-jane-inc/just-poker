...
class GamePlayerActionDTO(BaseModel):
    ...
    accepted_at: Optional[StrictStr] = Field(
        default=None,
        description="a timestamp capturing when a succesful action was accepted by the game",
    )
    chips: Optional[Dict[str, StrictInt]] = Field(
        default=None,
        description="an optional mapping of chips that is required by some action types.",
    )
    intent: Optional[StrictStr] = Field(
        default=None, description="the type of action a player intended to preform"
    )
    player_id: Optional[StrictStr] = Field(
        default=None, description="the id of the player preforming the action"
    )
