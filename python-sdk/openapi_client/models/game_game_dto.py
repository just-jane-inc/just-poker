...
class GameGameDTO(BaseModel):
    ...
    started_at: Optional[StrictStr] = Field(
        default=None, description="the time that the game started originally"
    )
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "game_config": (
                    GameNewGameConfigDTO.from_dict(obj["game_config"])
                    if obj.get("game_config") is not None
                    else None
                ),
                "id": obj.get("id"),
                "started_at": obj.get("started_at"),
                "table": (
                    GameTableDTO.from_dict(obj["table"])
