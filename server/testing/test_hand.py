...
def player_action(
    game_id: str, player_id: str, action: str, chips: Dict[str, int], just_status=True
):
...
def create_user(username: str, twitch_id: str, usertype: str = "test"):
    url = f"{base_url}/user"
    payload = {"username": username, "user_type": usertype, "twitch_id": twitch_id}

    return requests.post(url, json=payload)


def EvaluateHand(hand: List[str]):
    url = "https://game.bahms.org/poker/hand-evaluator/evaluate"
