...
[assembly: InternalsVisibleTo("JustPoker.OpenApi.Test")]
...
namespace JustPoker.OpenApi.Client
{
    ...
    public static partial class ClientUtils
    {
        ...
        public static string? ParameterToString(object? obj, string? format = ISO8601_DATETIME_FORMAT)
        {
            ...
            if (obj is bool boolean)
                return boolean
                    ? "true"
                    : "false";
            if (obj is AdminGameStatus adminGameStatus)
                return AdminGameStatusValueConverter.ToJsonValue(adminGameStatus);
            if (obj is GamePlayerIntent gamePlayerIntent)
                return GamePlayerIntentValueConverter.ToJsonValue(gamePlayerIntent);
            if (obj is GameRoundType gameRoundType)
                return GameRoundTypeValueConverter.ToJsonValue(gameRoundType);
            if (obj is JustErrorCode justErrorCode)
                return JustErrorCodeValueConverter.ToJsonValue(justErrorCode).ToString();
            if (obj is JustUserType justUserType)
                return JustUserTypeValueConverter.ToJsonValue(justUserType);
        ...
        /// </summary>
        public const string BASE_ADDRESS = "https://game.bahms.org/api/poker";
        ...
        /// </summary>
        public const string CONTEXT_PATH = "/api/poker";

        /// <summary>
        /// The host of the API
        /// </summary>
        public const string HOST = "game.bahms.org";
